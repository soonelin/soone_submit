        ...
        <tr>
          ...
          <td>
            ...
            <{if $xoops_isadmin}>
              ...
              <a href="./main.php?op=confirm_article&article_id=<{$content.article_id}>" class="btn btn-info btn-xs">設定優選</a>
              <a href="./main.php?op=unconfirm_article&article_id=<{$content.article_id}>" class="btn btn-success btn-xs">取消優選</a>
            <{/if}>
          </td>
        </tr>
    <{/foreach}>
